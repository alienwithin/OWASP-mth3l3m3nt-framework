...
The DB Dump in place is for users who use MySQL and need demo data. Unfortunately I have only done for MySQL. It's mine of choice. 

If you would like to switch from JIG , other supported Databases are: 
